            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Top lương nhân viên</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php
                                include 'connect.php';
                                $sql = "SELECT nhan_vien_tbl.ten, nhan_vien_tbl.ngay_sinh, nhan_vien_tbl.gioi_tinh, nhan_vien_tbl.so_dien_thoai, nhan_vien_tbl.id_chuc_vu, luong_tbl.tong_luong
                                        FROM luong_tbl
                                        INNER JOIN nhan_vien_tbl ON luong_tbl.id_nhanvien = nhan_vien_tbl.id_nv
                                        ORDER BY luong_tbl.tong_luong DESC
                                        LIMIT 4
                                ";
